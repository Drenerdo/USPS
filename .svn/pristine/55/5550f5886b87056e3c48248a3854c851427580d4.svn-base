...
//Shift a bit field value into an integer from the right.
...
#define SET_BIT_FIELD(VARIABLE, VALUE, OFFSET, BITS) \
	VARIABLE = (VARIABLE & (~BIT_FIELD_MASK(OFFSET, BITS))) | BIT_FIELD_VALUE(VALUE, OFFSET, BITS));
